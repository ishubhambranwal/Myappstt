...
public class homeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bt=  view.findViewById(R.id.entr_btn);
        bt2= view.findViewById(R.id.quote);
        bt3= view.findViewById(R.id.chtn);
        bt4= view.findViewById(R.id.gme);
        bt5= view.findViewById(R.id.shp);
        bt6= view.findViewById(R.id.stdy);
        bt7= view.findViewById(R.id.ofr);
        bt8= view.findViewById(R.id.nws);
